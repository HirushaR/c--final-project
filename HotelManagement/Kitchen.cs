    ...
    public partial class Kitchen : MetroForm
    {
        ...
        private void MetroButton2_Click(object sender, EventArgs e)
        {
            if (connection.State != ConnectionState.Open)
            {
                ...
                try
                {
                    ...
                    UPDATE menuItems
                    SET 
                    item_name = '{metroTextBox2.Text.Trim()}',
                    item_description = '{metroTextBox5.Text.Trim()}',
                    item_price = '{metroTextBox4.Text.Trim()}',
                    item_category = '{metroTextBox3.Text.Trim()}'
                    WHERE
                    item_no = '{metroTextBox1.Text.Trim()}'";
        ...
        private void MetroButton3_Click(object sender, EventArgs e)
        {
            if (connection.State != ConnectionState.Open)
            {
                try
                {
                    string deleteString = $"DELETE from menuItems where item_no = '{metroTextBox6.Text.Trim()}'";
        ...
        private void MetroButton4_Click(object sender, EventArgs e)
        {
            if (connection.State != ConnectionState.Open)
            {
                ...
                try
                {
                    string query = $"SELECT * FROM menuItems WHERE item_name = '{metroTextBox6.Text.Trim()}'";
                    SqlCommand cmd = new SqlCommand(query, connection);
                    connection.Open();
                    reader = cmd.ExecuteReader();
                    while (reader.Read())
                    {
                        metroTextBox1.Text = reader["item_no"].ToString();
                        metroTextBox2.Text = reader["item_name"].ToString();
                        metroTextBox5.Text = reader["item_description"].ToString();
                        metroTextBox4.Text = reader["item_price"].ToString();
                        metroTextBox3.Text = reader["item_category"].ToString();
                    }
                }
                catch (SqlException ex)
                {
        ...
        private void MetroButton5_Click(object sender, EventArgs e)
        {
            ...
            if (connection.State != ConnectionState.Open)
            {
                ...
                try
                {
                    string query = $"SELECT * FROM menuItems WHERE item_no = '{metroTextBox6.Text.Trim()}'";
                    SqlCommand cmd = new SqlCommand(query, connection);
                    connection.Open();
                    reader = cmd.ExecuteReader();
                    while (reader.Read())
